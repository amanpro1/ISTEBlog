...
<?php 
  ...
  if(isset($_POST['Submit'])){
    ...
    $sql = "UPDATE posts SET datetime='$DateTime', title='$PostTitle',category='$Category',main='$FeaturedType', tags='$Tags',subtitle='$PostText'";
    if($FeaturedType == 'SingleImage'){
      ...
      $sql .= ",thumbnail='$SingleImage' WHERE id='$PostId'";
      ...
      $sql .= ",thumbnail='$QuoteImage',multipurpose='$Quote' WHERE id='$PostId'";
      ...
      if(empty($Image3) && empty($Image4) && empty($Image5)){
        ...
        $sql .= ",thumbnail='$Image1',multipurpose='$Image2' WHERE id='$PostId'"; 
      ...
      elseif(!empty($Image3) && empty($Image4) && empty($Image5)){
        $sql .= ",thumbnail='$Image1',multipurpose='$Image2',image3='$Image3' WHERE id='$PostId'";
        move_uploaded_file($_FILES["Image1"]["tmp_name"],$TargetImage1);
        move_uploaded_file($_FILES["Image2"]["tmp_name"],$TargetImage2);
        move_uploaded_file($_FILES["Image3"]["tmp_name"],$TargetImage3);
      }
      elseif(!empty($Image3) && !empty($Image4) && empty($Image5)){
        $sql .= ",thumbnail='$Image1',multipurpose='$Image2',image3='$Image3',image4='$Image4' WHERE id='$PostId'"; 
        move_uploaded_file($_FILES["Image1"]["tmp_name"],$TargetImage1);
        move_uploaded_file($_FILES["Image2"]["tmp_name"],$TargetImage2);
        move_uploaded_file($_FILES["Image3"]["tmp_name"],$TargetImage3);
        move_uploaded_file($_FILES["Image4"]["tmp_name"],$TargetImage4);
      }elseif(!empty($Image3) && !empty($Image4) && !empty($Image5)) {
        $sql .= ",thumbnail='$Image1',multipurpose='$Image2',image3='$Image3',image4='$Image4',image5='$Image5' WHERE id='$PostId'";
        move_uploaded_file($_FILES["Image1"]["tmp_name"],$TargetImage1);
        move_uploaded_file($_FILES["Image2"]["tmp_name"],$TargetImage2);
        move_uploaded_file($_FILES["Image3"]["tmp_name"],$TargetImage3);
        move_uploaded_file($_FILES["Image4"]["tmp_name"],$TargetImage4);
      ...
      $sql .= ",thumbnail='$ImageThumbnail',multipurpose='$VideoLink' WHERE id='$PostId'";
      ...
      $ImageThumbnail = round(microtime(true)) . '.' . end($temp);
      $TargetImageThumbnail = "Uploads/".$ImageThumbnail;
      $sql .= ",thumbnail='$ImageThumbnail',multipurpose='$AudioLink' WHERE id='$PostId'";
    ...
    global $ConnectingDB;
        ...
        if($Execute){
            ...
            $_SESSION["ErrorMessage"]= "Something went wrong. Try Again !";
            Redirect_to("EditPost1.php?id=$PostId");
        }
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <header class="bg-dark text-white py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          <h1><i class="fas fa-edit" style="color:#27aae1;"></i> Edit Post(Step 1)</h1>
          </div>
        </div>
      </div>
    </header>
        ...
        <div class="row">
            <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
              <?php
                ...
                echo SuccessMessage();
              ?>
                <form id="formid" action="EditPost1.php?id=<?php echo $PostId;  ?>" method="post" enctype="multipart/form-data">

        ...
        <div class="row">
          ...
          <div class="col-lg-3 mb-2">
            <a href="EditPost.php" class="btn btn-success btn-block">
              <i class="fas fa-check"></i> Drafted Post
            </a>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12">
          ...
          <table class="table table-striped table-hover">
            ...
            <tr>
              ...
              <th>Author</th>
              <th>Banner</th>
              <th>Edit(from scratch)</th>
              <th>Action(Edit Content)</th>
              <th>Live Preview</th>
            </tr>
            </thead>
                    <?php
          ...
          <td>
              ...
              <a href="EditPost1.php?id=<?php echo $Id; ?>"><span class="btn btn-warning">Edit Title,etc. </span></a>
                </td>
              <td>
              ...
              <td>
              <a href="FullPostNew.php?id=<?php echo $Id; ?>" target="_blank"><span class="btn btn-primary">Live Preview</span></a>
              </td>
                </tr>
                </tbody>

      ...
      <div class="row" style="min-height:30px;">
        <div class="col-lg-12" style="min-height:400px;">
          ...
          while ($DataRows=$Execute->fetch()) {
            ...
            $DateTimeOfComment = strftime('%d-%m-%Y',$DateTimeOfComment);
          ...
          <tbody>
            <tr>
              ...
              <td> <a href="DisApproveComments.php?id=<?php echo $CommentId;?>" class="btn btn-success">Disapprove</a>  </td>
              <td> <a href="DeleteComments.php?id=<?php echo $CommentId;?>" class="btn btn-danger">Delete</a>  </td>
              <td style="min-width:150px;"> <a class="btn btn-primary"href="FullPostNew.php?id=<?php echo $CommentPostId; ?>" target="_blank">Live Preview</a> </td>
            </tr>
          </tbody>
          <?php } ?>
          </table>
          ...
          while ($DataRows=$Execute->fetch()) {
            ...
            $DateTimeOfComment = $DataRows["datetime"];
            $CommenterName     = $DataRows["name"];
            $DisApprovedBy     = $DataRows["disapprovedby"];
            $CommentContent    = $DataRows["comment"];
            $CommentPostId     = $DataRows["post_id"];
            $SrNo++;
          ?>
          <tbody>
            <tr>
              ...
              <td style="min-width:140px;"> <a href="ApproveComments.php?id=<?php echo $CommentId;?>" class="btn btn-warning">Approve</a>  </td>
              <td> <a href="DeleteComments.php?id=<?php echo $CommentId;?>" class="btn btn-danger">Delete</a>  </td>
              <td style="min-width:140px;"> <a class="btn btn-primary"href="FullPostNew.php?id=<?php echo $CommentPostId; ?>" target="_blank">Live Preview</a> </td>
            </tr>
          </tbody>
          <?php } ?>
          </table>
